...
/**
 * Component hiển thị một Bài viết (PostCard) trên Bảng tin.
 * Chứa logic xử lý:
 * - Hiển thị thông tin người đăng, ảnh bài viết, nội dung.
 * - Xử lý tính năng Like/Unlike sử dụng kỹ thuật Optimistic UI.
 * - Mở modal để báo cáo (Report) bài viết.
 *
 * @param {Object} props.post - Dữ liệu của bài viết.
 * @param {Function} props.onDeleted - Callback khi bài viết bị xóa.
 */
export default function PostCard({ post, onDeleted }) {
  ...
  /**
   * Hàm xử lý khi người dùng nhấn nút Like/Unlike.
   * Áp dụng kỹ thuật "Optimistic UI Update": 
   * Cập nhật trạng thái giao diện (UI) ngay lập tức (thêm/bớt like) trước khi gọi API,
   * mang lại cảm giác phản hồi tức thì, mượt mà cho người dùng. 
   * Nếu API trả về lỗi, tiến hành "rollback" lại trạng thái ban đầu.
   */
  ...
  /**
   * Hàm xử lý gửi báo cáo (Report) bài viết lên máy chủ.
   * @param {string} content Nội dung người dùng nhập giải thích lý do báo cáo.
   */
