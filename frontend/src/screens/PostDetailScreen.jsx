...
/**
 * Màn hình chi tiết bài viết (PostDetailScreen).
 * Chức năng:
 * - Gọi API để lấy chi tiết bài viết và danh sách các bình luận (Comments).
 * - Cung cấp giao diện để người dùng (User) có thể nhập và gửi bình luận mới.
 * - Hỗ trợ tương tác Thích (Like/Unlike) và Báo cáo (Report) từ bên trong màn hình chi tiết.
 */
export default function PostDetailScreen() {
  ...
  /**
   * Hàm xử lý Thích / Hủy thích bài viết (Like/Unlike) ở màn hình chi tiết.
   * Sử dụng kỹ thuật Optimistic UI: Tăng/giảm số Like trên màn hình ngay lập tức 
   * trước khi nhận kết quả từ API để giảm độ trễ trải nghiệm.
   */
  ...
  /**
   * Hàm xử lý gửi Bình luận (Comment).
   * Lấy nội dung từ state `comment`, gọi API `userService.createComment`.
   * Sau khi thành công, xóa trắng ô nhập liệu và gọi hàm `refresh()` để tải lại danh sách bình luận.
   */
  ...
  /**
   * Mở Modal xử lý Báo cáo (Report) bài viết.
   * Truyền nội dung báo cáo xuống API.
   * @param {string} content Nội dung lý do báo cáo
   */
